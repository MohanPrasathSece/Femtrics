    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-white">
        ...
        <motion.div
          ...
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] md:w-[800px] md:h-[800px] bg-gradient-to-r from-primary/20 to-rose-400/20 rounded-full blur-3xl"
        />
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              <motion.h1
                ...
                className="font-display text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 leading-tight mb-4"
              >
                {t("hero.title")}
              </motion.h1>
              ...
              >
                ...
                <Button 
                  ...
                  variant="outline" 
                  size="lg" 
                  className="px-4 py-3 md:px-8 md:py-6 border-2 border-gray-300 text-gray-700 hover:bg-gray-50 transition-all font-semibold rounded-lg text-sm md:text-base"
                >
                  <Link to="/about">
                    {t("hero.learnMore")}
                  </Link>
            ...
            >
              <div className="relative">
                ...
                <motion.div
                  ...
                  className="absolute -top-6 -right-6 w-16 h-16 bg-primary rounded-xl shadow-lg flex items-center justify-center"
                >
                ...
                <motion.div
                  ...
                  className="absolute -bottom-6 -left-6 w-14 h-14 bg-rose-400 rounded-xl shadow-lg flex items-center justify-center"
                >
